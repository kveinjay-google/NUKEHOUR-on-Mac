...
actor-v3 =
    ...
    .description =
    Soviet long-range artillery vehicle.
    Launches a large ballistic rocket that can
    be shot down by anti-air weapons.
...
actor-dred =
    .name = Dreadnought
    .description =
    Soviet heavy bombardment ship.
    Launches two large ballistic missiles that can
    be shot down by anti-air weapons.
      Strong vs Buildings, Defenses
...
actor-yacnst =
    .name = Construction Yard
    .description = Allows construction of Yuri base structures.

actor-yapowr =
    .name = Bio Reactor
    .description =
    Provides power for other structures.
    Power output scales with health.

actor-yabrck =
    .name = Barracks
    .description = Trains Yuri infantry.

actor-yarefn =
    .name = Slave Miner
    .description =
    Processes Ore and Gems into credits.
    Comes with five Slaves. Can undeploy into a vehicle.
...
actor-yadome =
    .name = Psychic Sensor
    .description = Provides radar and unlocks advanced units.
...
actor-init =
    .name = Initiate
    .description =
    Basic Yuri infantry with psychic attacks.
      Strong vs Infantry
      Weak vs Vehicles, Aircraft
...
actor-pcv =
    ...
    .description =
    Deploys into a Yuri Construction Yard.
      Special Ability: Deploys

actor-smin =
    .name = Slave Miner
    .description =
    Mobile refinery. Deploys into a Slave Miner.
      Special Ability: Deploys
...
actor-ytnk =
    .name = Gatling Tank
    .description =
    Anti-infantry and anti-air tank.
      Strong vs Infantry, Aircraft
      Weak vs Tanks

actor-yatech =
    .name = Battle Lab
    .description = Provides access to advanced Yuri technologies.

actor-yagrnd =
    .name = Grinder
    .description =
    Recycles units into credits.
    Also repairs vehicles.

actor-yadept =
    .name = Service Depot
    .description = Repairs vehicles and naval units.

actor-yayard =
    .name = Naval Yard
    .description = Produces Yuri naval units. Must be built on water.

actor-yapsyt =
    .name = Psychic Tower
    .description =
    Mind-controls nearby enemy units.
    Can control up to 3 units at once.
      Strong vs Infantry, Vehicles
      Weak vs Aircraft, Buildings

actor-natbnk =
    .name = Tank Bunker
    .description = Garrison a vehicle for protection.

actor-yagntc =
    .name = Genetic Mutator
    .description =
    Superweapon: Mutates infantry in the target area into Brutes.
    Maximum 1 can be built.
    .power-name = Genetic Mutator
    .power-description = Mutate infantry into Brutes owned by you.

actor-yappet =
    .name = Psychic Dominator
    .description =
    Superweapon: Mind-controls units and damages buildings.
    Maximum 1 can be built.
    .power-name = Psychic Dominator
    .power-description = Seize enemy units and shatter structures.

actor-virus =
    .name = Virus
    .description =
    Sniper infantry. Fires toxin darts.
      Strong vs Infantry
      Weak vs Vehicles, Aircraft
...
actor-caos =
    .name = Chaos Drone
    .description =
    Deploys to release chaos gas that drives nearby units berserk.
    Affected units attack allies first.
      Special Ability: Deploy

actor-tele =
    .name = Magnetron
    .description =
    Lifts and drags vehicles and ships. Damages buildings with a magnetic beam.
...
actor-mind =
    .name = Mastermind
    .description =
    Mind-controls multiple enemy units.
      Strong vs Infantry, Vehicles
      Weak vs Aircraft, Buildings
...
actor-disk =
    .name = Floating Disc
    .description =
    Hovering attack craft with laser weapons.
...
actor-bsub =
    .name = Boomer
    .description =
    Submarine with torpedoes and ballistic missiles.
      Strong vs Ships, Ground
      Weak vs Anti-Sub
